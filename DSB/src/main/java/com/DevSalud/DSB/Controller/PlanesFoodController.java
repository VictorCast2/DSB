...
public class PlanesFoodController {
    ...
    private Map<String, List<List<String>>> filterPlans(String disease, String healthClassification) {
        ...
        switch (disease) {
            case "Hipertensos":
                filteredPlans.putAll(filterHipertensosPlans(allPlans, healthClassification));
                break;
            case "Diabético Tipo I":
                filteredPlans.putAll(filterDiabetesTipo1Plans(allPlans, healthClassification));
                break;
            case "Diabético Tipo II":
                filteredPlans.putAll(filterDiabetesTipo2Plans(allPlans, healthClassification));
                break;
            default:
    ...
    private Map<String, List<List<String>>> filterHipertensosPlans(Map<String, List<List<String>>> allPlans, String healthClassification) {
        Map<String, List<List<String>>> filteredPlans = new HashMap<>();
    ...
    private Map<String, List<List<String>>> filterDiabetesTipo1Plans(Map<String, List<List<String>>> allPlans, String healthClassification) {
        Map<String, List<List<String>>> filteredPlans = new HashMap<>();
        switch (healthClassification) {
            case "Bajo Peso":
            ...
            case "Obesidad Tipo III":
            case "Obesidad Tipo IV":
                filteredPlans.put("diabetesTipo1ObesiadaTipo3y4", allPlans.get("diabetesTipo1ObesiadaTipo3y4"));
                break;
            default:
                break;
        }
    ...
    private Map<String, List<List<String>>> filterDiabetesTipo2Plans(Map<String, List<List<String>>> allPlans, String healthClassification) {
        Map<String, List<List<String>>> filteredPlans = new HashMap<>();
        switch (healthClassification) {
            case "Bajo Peso":
